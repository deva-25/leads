...
<html lang="en">
<head>
<title>LEADS | Farmer :: Login</title>
<!-- custom-theme -->
		...
		<div class="container">
			<div class="w3layouts_breadcrumbs_left">
				<ul>
					...
					<li><a href="{{url('/FarmerRegistration')}}">Register</a><span>/</span></li>
...
<!-- contact -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head">Farmer<span> Login</span> with us</h3>
			...
			<div class="w3ls_news_grids">
				<div class="col-md-12 w3_agile_mail_left">
					<div class="agileits_mail_grid_right1 agile_mail_grid_right1">
						<form action="{{url('/FarmerLogin')}}" method="post" enctype="multipart/form-data">
						{{ csrf_field() }}
							<span>
								<i>Username</i>
							...
							<span>
								<i>Password</i>
								<input type="password" name="txtPssword" placeholder="Password" required="">
							</span>
