...
<html lang="en">
<head>
<title>LEADS | Farmer :: Product</title>
<!-- custom-theme -->
...
<!-- services -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head">View <span>Products</span> Here</h3>
			<div class="w3_agile_image">
				<img src="images/1.png" alt=" " class="img-responsive" />
			</div>
            <div class="col-md-12 text-right">
                <h3>
                    <button type="reset" class="btn btn-default" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Add Product</button>
                </h3>
			</div>
            @include('farmer.addProduct')
			<div class="althide">
                @if($errors->any())
                    <h5>{{$errors->first()}}</h5>
                @endif
                            ...
                            @if ($object->UserId == $test->id)
								<tr> 
                                    ...
                                    <td><img src="products/{{ $object->image }}" width="100" height="100" alt="image" /></td>
                                      <td>
                                        <a class="agile-icon" href="#" data-toggle="modal" data-target="#ProductDelete-{{ $object->id }}">X</a>
                                    </td> 
                               	</tr>
                                 @endif
                                <?php $i++; ?>
                                @include('farmer.ProductDelete')
                               @endforeach
