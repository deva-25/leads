...
<html lang="en">
<head>
<title>LEADS | Farmer :: Gallary</title>
<!-- custom-theme -->
...
<!-- services -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head">Add <span>Gallary</span> Here</h3>
			<div class="w3_agile_image">
				<img src="images/1.png" alt=" " class="img-responsive" />
			</div>
            <div class="col-md-12 text-right">
                <h3>
                    <button type="reset" class="btn btn-default" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Add Gallary</button>
                </h3>
			</div>
            @include('farmer.addGallary')
			<div class="althide">
                @if($errors->any())
                    <h5>{{$errors->first()}}</h5>
                @endif
			...
			<div class="table-responsive bs-example ">
						<table class="table" id="example">
                            ...
                            @if ($object->userId == $test->id)
								<tr> 
                                	<td><?php echo $i; ?> </td> 
                                    <td>{{ str_limit($object->caption, 50) }}</td> 
                                    <td>{{ $object->description }}</td>
                                    <td><img src="gallary/{{ $object->image }}" width="100" height="100" alt="image" /></td>
                                    <td>
