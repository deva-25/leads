...
<html lang="en">
<head>
<title>LEADS | Farmer :: Feedback</title>
<!-- custom-theme -->
...
<!-- services -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head">View <span>Doctors Feedback</span> Here</h3>
						...
						<table class="table" id="example">
                            ...
                            @if ($object->userid == $test->id)
								<tr> 
									...
									<td>
                                        @if ($object->status == 0)
                                        <a>Waiting For Doctor Feedback</a>
                                        @elseif($object->status == 1)
                                        <a class="agile-icon" href="#" data-toggle="modal" data-target="#viewFeedback-{{ $object->id }}">View Feedback</a>
                                        @endif
                                    </td> 
                               	</tr>
                                 @endif
                                <?php $i++; ?>
                                @include('farmer.ViewFeedBack')
                               @endforeach
