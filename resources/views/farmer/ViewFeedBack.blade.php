<div class="modal fade" id="viewFeedback-{{ $object->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
							<div class="modal-dialog" role="document">
    							<div class="modal-content">
									<div class="modal-header my-Header">
    									<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
										<h3 class="modal-title" id="exampleModalLabel">View Feedback</h3>
									</div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-12 grid_box1">
                                                        ...
                                                        <textarea class="form-control1" placeholder="" name="txtDoctorFeedback" readonly="readonly">{{ $object->doctorFeedback }} </textarea>
