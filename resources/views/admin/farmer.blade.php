...
<html lang="en">
<head>
<title>LEADS | Admin :: Farmer</title>
<!-- custom-theme -->
...
<!-- services -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head">Our <span>Farmers</span> List</h3>
			...
			<div class="table-responsive bs-example ">
						<table class="table" id="example">
                            ...
                            <tbody> 
								...
								<tr> 
                                	<td><?php echo $i; ?> </td> 
                                    <td>{{ str_limit($object->Name, 50) }}</td> 
                                    <td>{{ $object->Address }}</td>
                                    <td>{{ str_limit($object->Email, 50) }}</td> 
                                    <td>{{ str_limit($object->Contact, 50) }}</td>
    								<td>{{ str_limit($object->Area, 50) }}</td> 
                                    <td>{{ str_limit($object->Spce, 50) }}</td>
									<td>
                                        @if ($object->status == 0)
                                        <a class="agile-icon" href="#" data-toggle="modal" data-target="#userApprove-{{ $object->id }}">Approve</a>
                                        @elseif($object->status == 1)
                                        <a class="agile-icon" href="#" data-toggle="modal" data-target="#userReject-{{ $object->id }}">Reject</a>
                                        @endif
                                    </td> 
                               	</tr>
                                <?php $i++; ?>
                                
                                @include('admin.FarmerApprove')
