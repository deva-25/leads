...
<html lang="en">
<head>
<title>LEADS | Doctor :: Remedy</title>
<!-- custom-theme -->
...
<!-- services -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head">Add <span>Remedy</span> Here</h3>
			<div class="w3_agile_image">
				<img src="images/1.png" alt=" " class="img-responsive" />
			</div>
			<div class="col-md-12 text-right">
                <h3>
                    <button type="reset" class="btn btn-default" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Add Remedy</button>
                </h3>
			</div>
            @include('doctor.addRemedy')
			<div class="althide">
                @if($errors->any())
                    <h5>{{$errors->first()}}</h5>
                @endif
			...
			<div class="table-responsive bs-example ">
						<table class="table" id="example">
                            ...
                            @if ($object->DoctorId == $test->doc_id)
								<tr> 
                                	<td><?php echo $i; ?> </td> 
                                    <td>{{ $object->Issue }}</td> 
                                    <td>{{ $object->Solution }}</td>
                                    <td>{{ $object->DoctorDescription }}</td> 
                                    <td><img src="doc_remedy/{{ $object->image }}" width="100" height="100" alt="image" /></td>
                                    <td>
