...
<html lang="en">
<head>
<title>LEADS | Doctor :: Settings</title>
<!-- custom-theme -->
	...
	<div class="welcome">
		<div class="container">
			...
			<div class="table-responsive bs-example ">
            		<form action="{{url('/DoctorChPsw')}}" method="post">
                        ...
                        {{ csrf_field() }}
                            <tbody> 
								<tr> 
                                    ...
                                    <td>:</td>
                                    <td align="left">{{$test->doc_username}}</td>
                              	</tr> 
                                <tr> 
                                ...
                                <input type="hidden" name="txtdoictoprId" value="{{$test->doc_id}}" />
                                <tr> 
                                	<td></td>
                                    <td></td>
