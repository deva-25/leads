...
<html lang="en">
<head>
<title>LEADS | Doctor :: Login</title>
<!-- custom-theme -->
		...
		<div class="container">
			<div class="w3layouts_breadcrumbs_left">
				<ul>
					...
					<li><a href="{{url('/DoctorRegistration')}}">Register</a><span>/</span></li>
...
<!-- contact -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head">Doctors<span> Login</span> with us</h3>
