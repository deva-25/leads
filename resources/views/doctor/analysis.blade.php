...
<html lang="en">
<head>
<title>LEADS | Doctor :: Analysis</title>
<!-- custom-theme -->
...
<!-- services -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head">Complaint <span>Analysis</span> List</h3>
								...
								<tr> 
									...
									<td>
                                        @if ($object->status == 0)
                                         ...
                                         <a class="agile-icon" href="#" data-toggle="modal" data-target="#exampleModal-{{ $object->id }}" data-whatever="@mdo" >Add Feedback</a>
                                        @elseif($object->status == 1)
                                         <a class="agile-icon" href="#" data-toggle="modal" data-target="#exampleModal-{{ $object->id }}" data-whatever="@mdo" >Verified</a>
                                        @endif
                                    </td> 
                               	</tr>
                                 ...
                                 @endif
                                <?php $i++; ?>
                                @include('doctor.verifyComplaint')
                               @endforeach
